...
export default function ServicesPage() {
  return (
    <main className="min-h-screen px-4 py-10 text-blue-50 sm:px-6 lg:px-8 lg:py-16">
      <div className="mx-auto flex max-w-6xl flex-col gap-8">
        <section className="rounded-2xl border border-cyan-400/20 bg-panel/80 p-6 shadow-2xl shadow-cyan-900/20 sm:p-8 lg:p-10">
          ...
          <p className="mt-5 max-w-4xl text-base leading-relaxed text-blue-100/80">
            Application-ready pilot design for Hub71+ Digital Assets conversations: Travel Rule + Crypto Risk + Case Continuity.
          </p>
          <p className="mt-4 max-w-4xl text-sm leading-relaxed text-blue-100/70">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link href="/contact" className="inline-flex items-center justify-center rounded-md border border-cyan-300/40 bg-cyan-500/10 px-4 py-2 text-sm font-medium text-cyan-100 transition hover:bg-cyan-500/20">Book Continuity Pilot Call</Link>
            <Link href="/signals" className="inline-flex items-center justify-center rounded-md border border-white/10 px-4 py-2 text-sm font-medium text-blue-100/80 transition hover:bg-white/5">Try the Interactive Pilot Demo</Link>
          </div>
        </section>
