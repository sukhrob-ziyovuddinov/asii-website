...
export function PlatformCapabilities() {
  return (
    <section className="mt-16">
      <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-300">Capabilities</p>
      <h2 className="mt-3 text-2xl font-semibold text-white sm:text-3xl">
        The core surfaces of the ASII Continuity Pilot
      </h2>
      <p className="mt-3 max-w-2xl text-base leading-relaxed text-blue-100/80">
        A focused set of capabilities built for Travel Rule compliance, crypto risk assessment, and case continuity — deployed as an overlay, not a system replacement.
      </p>
